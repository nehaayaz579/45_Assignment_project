...
var city_country_pair1 = city_country("karachi", "pakistan");
console.log(city_country_pair1);
var city_country_pair2 = city_country("istabul", "turky");
console.log(city_country_pair2);
var city_country_pair3 = city_country("Madina", "saudia arab");
